...
$sql = "SELECT c.jour_semaine, c.heure_debut, c.heure_fin
        ...
        WHERE dc.id_coach = 5 AND dc.disponible = 1
...
<head>
    ...
    <title>SPORTIFY - Musculation</title>
    <style>
        .availability-table {
            margin-top: 20px;
            width: 100%;
        ...
        <div class="coach-profile mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Iliès Matrixé - Coach, Musculation</h3>
                        <div class="row">
                        ...
                        <form id="form-email" action="mailto:ilies.matrixe@edu.ece.fr" method="post" enctype="text/plain">
