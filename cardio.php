...
$sql = "SELECT c.jour_semaine, c.heure_debut, c.heure_fin
        ...
        WHERE dc.id_coach = 2 AND dc.disponible = 1
...
<head>
    ...
    <title>SPORTIFY - Cardio-Training</title>
    <style>
        .availability-table {
            margin-top: 20px;
            width: 100%;
        ...
        <div class="coach-profile mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Maxine Detente - Coach, Cardio-Training</h3>
                        <div class="row">
                        ...
                        <form id="form-email" action="mailto:maxine.detente@edu.ece.fr" method="post" enctype="text/plain">
