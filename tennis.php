...
$sql = "SELECT c.jour_semaine, c.heure_debut, c.heure_fin
        ...
        WHERE dc.id_coach = 9 AND dc.disponible = 1
        ...
        <div class="coach-profile mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Nina Iguess - Coach, Tennis</h3>
                        <div class="row">
                        ...
                        <form id="form-email" action="mailto:nina.iguess@edu.ece.fr" method="post" enctype="text/plain">
