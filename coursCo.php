...
$sql = "SELECT c.jour_semaine, c.heure_debut, c.heure_fin
        ...
        WHERE dc.id_coach = 4 AND dc.disponible = 1
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Angela Baha - Coach, Cours Collectifs</h3>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="buttons mt-3 text-center">
                                    <a href="cvCoach.php?id=4" class="btn btn-info mr-2">Voir le CV</a>
                                </div>                            </div>
                        </div>
                        ...
                        <form id="form-email" action="angela.baha@edu.ece.fr" method="post" enctype="text/plain">
