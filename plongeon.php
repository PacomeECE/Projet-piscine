        ...
        <div class="coach-profile mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Nicolas Latetenba - Coach, Plongeon</h3>
                        <div class="row">
                        ...
                        <form id="form-email" action="mailto:nicolas.latetenbas@edu.ece.fr" method="post" enctype="text/plain">
